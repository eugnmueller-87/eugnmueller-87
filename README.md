...
|---|---|
| 🔴 **SpendLens** — AI procurement analytics platform. Ingests any spend file (CSV, Excel, SAP/Coupa), auto-maps messy columns via Claude, runs a 5-stage pipeline: column mapping → data cleanup → vendor classification → compliance flagging → supplier intelligence. EcoVadis-style compliance scorecards, CFO-ready Excel export, persistent spend timeline, embedded market intelligence agent. | [Link]([https://github.com/eugnmueller-87/SpendLens](https://github.com/eugnmueller-87/PROCUREMENT/blob/main/PROCUREMENT/SpendLens_App/README.md)) |
