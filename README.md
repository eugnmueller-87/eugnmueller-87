...
**The result.** 429 public price points on 100 models; a closed device loop with a 95 % complete timestamp chain; per-device TCO split into purchase price and cost to sale; a term analysis that shows the first year of a device's life is the expensive one, so short contracts must carry a higher monthly rate or a second rental cycle; early terminations losing money at every term, which points at the customer contract, not the price list.
